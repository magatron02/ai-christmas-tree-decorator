...
def test_setting_a_price_stores_it(client, temp_catalog, local):
    ...
    response = client.post("/api/catalog/products/017-06/price", data={"price": "250"})
...
def test_a_non_numeric_price_is_refused(client, temp_catalog, local):
    ...
    response = client.post("/api/catalog/products/017-06/price", data={"price": "แพง"})
...
def test_a_blank_price_is_accepted_and_sets_nothing(client, temp_catalog, local):
    ...
    response = client.post("/api/catalog/products/017-06/price", data={"price": ""})
...
def test_the_endpoint_is_localhost_only(client, temp_catalog, monkeypatch):
    ...
    assert client.post(
        "/api/catalog/products/017-06/price", data={"price": "10"}
    ).status_code == 403
